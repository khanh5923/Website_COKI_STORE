            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered ">
                    ...
                    <tr>
                        ...
                        <td><a href="../admin/chitietdonmua.php?tg=<?php echo urlencode($row_order['order_date'])?>">Xem
                                giao
                                dịch </a></td>
                        <td><a
                                href="../admin/xulydonhang.php?stt=1&tg=<?php echo urlencode($row_order['order_date'])?>">Xác
                                nhận</a> ||<a
                                href="../admin/xulydonhang.php?stt=0&tg=<?php echo  urlencode($row_order['order_date'])?>">Hủy
                                đơn</a>
                        </td>
                    </tr>
                    <?php
