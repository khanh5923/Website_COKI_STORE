...
//mk  tu database
        try {
                    ...
                    $mail->Body = '<p>Your code: <b>'.$row['code_password']. '</b></p> <p><a href="http://localhost:8080/myProject/Coki_1155/Coki_1812/Coki/include/change_password.php">Click here</a> to change your password</p>';
